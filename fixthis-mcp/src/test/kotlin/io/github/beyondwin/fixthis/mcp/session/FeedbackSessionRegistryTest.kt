...
class FeedbackSessionRegistryTest {
    ...
    fun listSessionsResolvesPackageOverride() {
        ...
        val sessions = registry.listSessions(packageNameOverride = "io.github.beyondwin.fixthis.sample")
    ...
    fun transientConsoleSessionUsesDefaultPackage() {
        ...
        assertEquals("io.github.beyondwin.fixthis.sample", transient.packageName)
