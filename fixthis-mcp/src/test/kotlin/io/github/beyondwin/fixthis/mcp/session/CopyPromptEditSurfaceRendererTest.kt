...
class CopyPromptEditSurfaceRendererTest {
    ...
    fun renderSampleStyleHandoffExposesEditSurfacesAndWarnings() {
        ...
        val session = SessionDto(
            ...
            items = listOf(
                styleItem("item-metric-background", metricCard, "여기 배경 초록색", 1, EditSurfaceKindDto.CONTAINER_COLOR, "sample/src/main/java/io/github/beyondwin/fixthis/sample/components/MetricCard.kt", 26, EditSurfaceReasonDto.STYLE_INTENT, EditSurfaceReasonDto.TARGET_OWNER),
                styleItem("item-resolved-this-week", resolvedThisWeek, "여기 글자 파란색", 2, EditSurfaceKindDto.TEXT_COLOR, "sample/src/main/java/io/github/beyondwin/fixthis/sample/components/MetricCard.kt", 26, EditSurfaceReasonDto.STYLE_INTENT, EditSurfaceReasonDto.TARGET_OWNER),
                styleItem("item-priority-feedback", priorityFeedback, "여기 텍스트 더크게", 3, EditSurfaceKindDto.TYPOGRAPHY, "sample/src/main/java/io/github/beyondwin/fixthis/sample/components/SectionHeader.kt", 24, EditSurfaceReasonDto.TYPOGRAPHY_INTENT, EditSurfaceReasonDto.SELECTED_TEXT_RENDERER),
                styleItem("item-open-queue", openQueue, "여기 글자 빨간색", 4, EditSurfaceKindDto.TEXT_COLOR, "sample/src/main/java/io/github/beyondwin/fixthis/sample/components/SectionHeader.kt", 29, EditSurfaceReasonDto.STYLE_INTENT, EditSurfaceReasonDto.SELECTED_TEXT_RENDERER),
                styleItem("item-feedback-card-spacing", feedbackCard, "여기 아래 바텀마진 8dp더", 5, EditSurfaceKindDto.SPACING, "sample/src/main/java/io/github/beyondwin/fixthis/sample/screens/HomeScreen.kt", 51, EditSurfaceReasonDto.LAYOUT_INTENT, EditSurfaceReasonDto.LIST_ITEM_SPACING),
                styleItem("item-resolved-chip", resolvedChip, "여기 텍스트컬리 보라색", 6, EditSurfaceKindDto.CHIP_COLOR, "sample/src/main/java/io/github/beyondwin/fixthis/sample/components/StatusChip.kt", 45, EditSurfaceReasonDto.STYLE_INTENT, EditSurfaceReasonDto.COMPONENT_DEFINITION),
            ),
        )
