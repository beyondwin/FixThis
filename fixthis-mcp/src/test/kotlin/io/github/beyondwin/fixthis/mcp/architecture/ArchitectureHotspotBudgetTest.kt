...
class ArchitectureHotspotBudgetTest {
    ...
    fun handwrittenKotlinFilesStayUnderBudgetUnlessExplicitlyAllowed() {
        ...
        val productionKotlinBudgets = mapOf(
            ...
            "fixthis-compose-core/src/main/kotlin/io/github/beyondwin/fixthis/compose/core/source/SourceMatcher.kt" to 589,
            ...
            "${gradlePlugin}source/KotlinSourceScanner.kt" to 355,
        )
        ...
        val testBudgets = mapOf(
            "fixthis-mcp/src/test/kotlin/io/github/beyondwin/fixthis/mcp/session/CompactHandoffRendererTest.kt" to 2_486,
