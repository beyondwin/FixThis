...
class ArchitectureHotspotBudgetTest {
    ...
    private val productionKotlinBudgets = mapOf(
        ...
        "${mcpMain}session/verification/VerificationArtifactDirectoryAccess.kt" to 210,
        "${mcpMain}session/verification/VerificationArtifactFileOperations.kt" to 213,
        "${mcpMain}session/verification/VerificationArtifactMaintenanceFileSystem.kt" to 66,
        "${mcpMain}session/verification/VerificationArtifactOperationLocks.kt" to 100,
        "${mcpMain}session/verification/VerificationArtifactSecureFileSystem.kt" to 213,
