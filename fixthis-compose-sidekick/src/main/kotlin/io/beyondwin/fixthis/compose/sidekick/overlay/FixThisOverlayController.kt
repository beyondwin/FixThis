...
import io.beyondwin.fixthis.compose.overlay.OverlayStateMachine
import io.beyondwin.fixthis.compose.overlay.FixThisDraft
import io.beyondwin.fixthis.compose.sidekick.capture.AnnotationCaptureController
import io.beyondwin.fixthis.compose.sidekick.capture.AnnotationCaptureInput
import io.beyondwin.fixthis.compose.sidekick.export.ClipboardExportResult
import io.beyondwin.fixthis.compose.sidekick.export.ClipboardExporter
import io.beyondwin.fixthis.compose.sidekick.export.LocalFileExporter
...
internal class FixThisOverlayController(
    ...
    private var currentAnnotation: FixThisAnnotation? = null
    private var lastSubmittedAnnotation: FixThisAnnotation? = null
    ...
    private data class ActiveCapture(
        val tap: TapPoint,
        val areaBoundsInWindow: FixThisRect?,
    )

    private fun markSubmitted(annotation: FixThisAnnotation) {
...
internal data class FeedbackCaptureWaitResult(
    ...
    val annotation: FixThisAnnotation?,
...
private fun FixThisAnnotation.toDraft(): FixThisDraft =
    FixThisDraft(
