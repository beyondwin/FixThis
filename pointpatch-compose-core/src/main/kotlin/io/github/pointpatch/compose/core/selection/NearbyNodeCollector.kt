...
object NearbyNodeCollector {
    ...
    private fun centerDistance(first: PointPatchNode, second: PointPatchNode): Float {
...
internal val io.github.pointpatch.compose.core.model.PointPatchRect.centerX: Float
    get() = (left + right) / 2f

internal val io.github.pointpatch.compose.core.model.PointPatchRect.centerY: Float
    get() = (top + bottom) / 2f

internal fun PointPatchNode.semanticIdentity(): String {
    val parts = listOf(
        role.orEmpty(),
        text.joinToString("\u001f"),
