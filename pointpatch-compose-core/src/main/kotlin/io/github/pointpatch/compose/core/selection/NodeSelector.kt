package io.github.pointpatch.compose.core.selection

import io.github.pointpatch.compose.core.model.PointPatchNode
import io.github.pointpatch.compose.core.model.PointPatchRect
import io.github.pointpatch.compose.core.model.ScoredPointPatchNode
...
object NodeSelector {
    ...
    private fun score(node: PointPatchNode, tap: TapPoint, largestAreaAtPoint: Float): ScoredPointPatchNode {
    ...
    private fun actionScore(node: PointPatchNode): Double {
    ...
    private fun semanticScore(node: PointPatchNode): Double {
        var score = 0.0
    ...
    private fun centerProximityScore(bounds: PointPatchRect, tap: TapPoint): Double {
    ...
    private fun isRootLike(node: PointPatchNode, largestAreaAtPoint: Float): Boolean {
    ...
    private fun labelFor(node: PointPatchNode): String {
        val parts = buildList {
    ...
    private fun PointPatchNode.primaryText(): String? =
