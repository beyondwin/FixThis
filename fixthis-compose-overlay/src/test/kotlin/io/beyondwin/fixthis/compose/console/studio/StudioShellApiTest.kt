...
class StudioShellApiTest {
    ...
    fun feedbackConsoleScreenIsPublicEntrypointWithoutViewModelParameter() {
        val shellClass = Class.forName("io.beyondwin.fixthis.compose.console.studio.StudioShellKt")
        ...
        assertTrue(
            ...
            entrypoints.none { method ->
                method.parameterTypes.any { it.name == "io.beyondwin.fixthis.compose.console.studio.StudioViewModel" }
            },
        )
        assertTrue(
            "FeedbackConsoleScreen should expose optional ScreenshotInfo preview input",
            entrypoints.any { method ->
                method.parameterTypes.any { it.name == "io.beyondwin.fixthis.compose.core.model.ScreenshotInfo" }
            },
        )
