...
@Preview(widthDp = 360)
@Composable
private fun PointPatchCommentSheetPreview() {
    MaterialTheme {
            ...
            draft = PointPatchDraft(
                scopeCandidates = listOf(
                    ScopeCandidate(
                        label = "Checkout row",
                        nodeUid = "row",
                        boundsInWindow = PointPatchRect(0f, 0f, 240f, 64f),
                        score = 0.9,
                    ),
                ),
                screenshot = ScreenshotInfo(cropPath = "/tmp/pointpatch/crop.png", width = 240, height = 96),
