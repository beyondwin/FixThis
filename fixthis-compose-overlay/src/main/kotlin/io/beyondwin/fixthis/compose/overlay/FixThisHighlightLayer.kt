...
private fun FixThisRect.toLocalRect(windowOrigin: Offset): Rect =
    Rect(
...
@Composable
private fun FixThisHighlightLayerPreview() {
    MaterialTheme {
        FixThisHighlightLayer(
            selectedBounds = FixThisRect(32f, 96f, 240f, 152f),
            scopeCandidates = listOf(
                ScopeCandidate(
                    label = "Checkout row",
                    nodeUid = "row",
                    boundsInWindow = FixThisRect(20f, 80f, 300f, 180f),
                    score = 0.86,
                ),
            ),
