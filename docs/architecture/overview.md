...
- The `generate<Variant>FixThisSourceIndex` task scans Kotlin/XML sources from the app module and project dependencies on that debug variant's compile/runtime classpath, then produces the generated asset.
