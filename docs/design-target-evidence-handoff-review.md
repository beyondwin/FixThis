...
- `fixthis-compose-core/src/main/kotlin/io/beyondwin/fixthis/compose/core/identity/` (신설) — TestTagConvention, IdentityHint, OccurrenceCalculator
- `fixthis-compose-sidekick/src/main/kotlin/io/beyondwin/fixthis/compose/sidekick/inspect/SemanticsNodeMapper.kt` — stable parent/children UID contract를 추가할 때 영향
...
- `fixthis-compose-sidekick/src/main/kotlin/io/beyondwin/fixthis/compose/sidekick/bridge/BridgeServer.kt` — readScreenshot kind 확장, future breaking protocol changes only
