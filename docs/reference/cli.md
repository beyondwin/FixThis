...
| `--plugin-version` | `1.5.0` | FixThis Gradle plugin version to apply when `--apply-gradle-plugin` is set. |
...
| `--plugin-version` | `1.5.0` | FixThis Gradle plugin version to apply. |
