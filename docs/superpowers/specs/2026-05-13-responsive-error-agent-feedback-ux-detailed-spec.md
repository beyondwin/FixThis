...
- `fixthis-mcp/src/main/kotlin/io/beyondwin/fixthis/mcp/session/SessionDtoModels.kt:124` — status enum
- `fixthis-mcp/src/main/kotlin/io/beyondwin/fixthis/mcp/session/FeedbackSessionStore.kt:474` — allowed agent resolution statuses
- `fixthis-mcp/src/main/kotlin/io/beyondwin/fixthis/mcp/tools/FixThisToolDispatcher.kt:433` — MCP string to status mapping
...
- `fixthis-mcp/src/main/kotlin/io/beyondwin/fixthis/mcp/tools/McpToolRegistry.kt:181` — `agentNote` tool schema
- `fixthis-mcp/src/main/kotlin/io/beyondwin/fixthis/mcp/tools/FixThisToolDispatcher.kt:205` — `agentNote` read
- `fixthis-mcp/src/main/kotlin/io/beyondwin/fixthis/mcp/session/FeedbackSessionStore.kt:517` — `agentSummary = agentNote`
...
- `sample/src/main/java/io/beyondwin/fixthis/sample/FixThisStudioApp.kt:37` — 5개 tab NavigationBar
- `sample/src/main/java/io/beyondwin/fixthis/sample/components/StudioHeader.kt:25` — title/subtitle + status row
- `sample/src/main/java/io/beyondwin/fixthis/sample/components/FeedbackCard.kt:38` — title + severity row
- `sample/src/main/java/io/beyondwin/fixthis/sample/components/FeedbackCard.kt:68` — action row
- `sample/src/main/java/io/beyondwin/fixthis/sample/components/InfoRow.kt:32` — content + trailing row
- `sample/src/main/java/io/beyondwin/fixthis/sample/screens/ProjectScreen.kt:53` — chip row
- `sample/src/main/java/io/beyondwin/fixthis/sample/screens/ProjectScreen.kt:96` — action row
- `sample/src/main/java/io/beyondwin/fixthis/sample/screens/ReviewScreen.kt:108` — checkbox row
- `sample/src/main/java/io/beyondwin/fixthis/sample/screens/ReviewScreen.kt:122` — switch row
- `sample/src/main/java/io/beyondwin/fixthis/sample/screens/DiagnosticsScreen.kt:62` — intentional long label + disabled action stress case
...
- `fixthis-compose-sidekick/src/main/kotlin/io/beyondwin/fixthis/compose/sidekick/overlay/FixThisConnectionStatusHostLayout.kt:51` — horizontal pill
- `fixthis-compose-sidekick/src/main/kotlin/io/beyondwin/fixthis/compose/sidekick/overlay/FixThisConnectionStatusHostLayout.kt:63` — text layout params wrap content
- `fixthis-compose-sidekick/src/main/kotlin/io/beyondwin/fixthis/compose/sidekick/overlay/FixThisConnectionStatusHostLayout.kt:153` — top/end placement
