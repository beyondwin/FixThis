...
import io.github.beyondwin.fixthis.compose.core.model.ActivityInfo
import io.github.beyondwin.fixthis.compose.core.model.AppInfo
...
import io.github.beyondwin.fixthis.compose.core.model.ScreenshotInfo
    ...
    private fun annotationWithTargetEvidence(): FixThisAnnotation {
        ...
        return annotation(
            ...
            sourceCandidates = listOf(
                ...
                SourceCandidate(
                    file = "sample/src/main/java/io/github/beyondwin/fixthis/sample/components/SecondaryButton.kt",
                    line = 7,
                    score = 0.72,
                ...
                SourceCandidate(
                    file = "sample/src/main/java/io/github/beyondwin/fixthis/sample/LoginScreen.kt",
                    line = 88,
                    score = 0.61,
                ...
                SourceCandidate(
                    file = "sample/src/main/java/io/github/beyondwin/fixthis/sample/UnusedButton.kt",
                    line = 12,
                    score = 0.1,
                    matchedTerms = listOf("Button"),
