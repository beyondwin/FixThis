...
internal val io.github.beyondwin.fixthis.compose.core.model.FixThisRect.centerX: Float
    get() = (left + right) / 2f

internal val io.github.beyondwin.fixthis.compose.core.model.FixThisRect.centerY: Float
    get() = (top + bottom) / 2f
